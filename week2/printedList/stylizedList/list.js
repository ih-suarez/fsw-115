...
import { VERSION, map, forEach } from '/lodash'
...
let planetsName = map(planets.results, 'name')


forEach(planetsName, (name) => {
    const li = document.createElement('li')
    let nameOfPlanet = document.createTextNode(name)
        li.appendChild(nameOfPlanet)
